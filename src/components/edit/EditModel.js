                ...
                <div className="border-b border-gray-900/10 pb-12">
                    ...
                    <div div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div className="sm:col-span-4">
                            ...
                            <div className="flex items-center gap-x-3">
                                <input
                                    ...
                                    type="radio"
                                    value="others"
                                    checked={editedData.gender === 'others'}
                                    onChange={handleInputChange}
                                    className="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600"
                                />
                        ...
                        <div className="sm:col-span-3">
                            ...
                            {editedData.maritalStatus === 'Married' && (
                                <div className="sm:col-span-4">
                        ...
                        <div className="sm:col-span-3">
                            ...
                            {editedData.qualification === 'Others' && (
                                <div className="sm:col-span-4">
                                    <label htmlFor="others" className="block text-sm font-medium leading-6 text-gray-900">
                                        Please Specify
                                    </label>
                            ...
                            <div className="mt-2">
                                <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                    ...
                                    <input
                                        ...
                                        id="altMobileNumber"
                                        value={editedData.altMobileNumber}
                                        onChange={handleInputChange}
